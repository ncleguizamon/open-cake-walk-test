...
const HelloWorldIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Hello Camilo';
        return handlerInput.responseBuilder
            .speak(speakOutput)
...
const HelloDeploydIntentHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'HelloDeploydIntent';
    },
    handle(handlerInput) {
        const speakOutput = 'deployed enviroment ';
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt("testing")
            .getResponse();
